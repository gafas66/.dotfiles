...
before packages are loaded."
  (require 'org-macs)
  ;;(require 'org-drill) ;;FIXME This causes error
  ...
  (setq org-agenda-files (directory-files-recursively "~/init/org/" "\.org$"))
