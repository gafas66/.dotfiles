...
** When packages are not loaded or "compatible"
...
#+begin_src emacs-lisp
  (when (window-system)
    (use-package doom-modeline
      ...
      :config
      ;;(set-face-attribute 'mode-line-inactive  nil :background "#333" :foreground "#999") ;; cant change foreground?
      (set-face-attribute 'mode-line-inactive  nil :foreground "#fff") ;; cant change foreground?
